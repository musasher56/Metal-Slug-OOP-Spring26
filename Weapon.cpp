...
Weapon::Weapon(int weaponType, int dmg, float rate, int amm): ammo(amm), fireRate(rate), damage(dmg), type(weaponType)
{}
...
ProjectileWeapon::ProjectileWeapon(int wt, int dmg, float rate, int amm, int pc): Weapon(wt, dmg, rate, amm), projectileClass(pc)
{}

ProjectileWeapon::~ProjectileWeapon() {}

Pistol::Pistol(): ProjectileWeapon(WEAPON_PISTOL, 3, 4.f, -1, PROJ_STRAIGHT), infinite(true)
{}
...
HeavyMachineGun::HeavyMachineGun(): ProjectileWeapon(WEAPON_HMG, 3, 8.f, 100, PROJ_STRAIGHT)
{}
...
RocketLauncher::RocketLauncher(): ProjectileWeapon(WEAPON_ROCKET_LAUNCHER, 5, 0.5f, 10, PROJ_EXPLOSIVE), reloadTime(2.0f)
{}
...
FlameShot::FlameShot(): Weapon(WEAPON_FLAME_SHOT, 2, 10.f, 50), streamLength(5)
{}
...
LaserGun::LaserGun(): Weapon(WEAPON_LASER_GUN, 999, 0.5f, 20)
{}
